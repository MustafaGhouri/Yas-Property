...
<body>
  ...
  <div class="page-top">
    <h1 class="property-head">About Us</h1>

 </div>
<div class="container about-first">
    <div class="row">
        <div class="col-lg-4 ">
<img src="images/about-main.png"  class="about-left" alt="">
        </div>
        <div class="col-lg-8 about-right">
            <div class="content">
<h5 class="about-head">About Us</h5>
<h1 class="About-main-head">  The Leading Real Estate<br> Rental Marketplace.</h1>
<p>Over 39,000 people workn for us in more than 70 countries all over <br> the This breadth Of global coverage, combinexd with specialist <br>services.</p>
</div>
...
<div class="sm-cart">
    <div class="sm-cart-1">
        ...
        &nbsp; &nbsp; 
        <h6 class="mt-2">Complete 24/7 Security</h6>
    </div>
    ...
    <div class="sm-cart-2">
      ...
      &nbsp;  &nbsp; 
        <h6 class="mt-2">
Smart Home design</h6>
    </div>
</div>

<div class="sm-cart mt-3">
    <div class="sm-cart-1">
      <i class="bi bi-balloon-heart"></i>
      &nbsp;  &nbsp; 
        <h6 class="mt-2">Beautiful Scene Around </h6>
    </div>
    ...
    <div class="sm-cart-2">
      ...
      &nbsp;  &nbsp; 
        <h6 class="mt-2">
            Exceptional Lifestyle</h6>
    </div>
</div>
<div class="red-box mt-4">
    <p>"Enimad minim veniam quis nosturd exercitation <bR> llamco laboris.Lorem Ipsum Dolor sit amet".</p>
</div>
<div class="about-btn mt-5-1">
...
<div class="team-sec"> 
  <h2 class="text-center my-5 team-main">Our Team</h2>
  <div class="container">
    <div class="row">
      <div class="col-lg-3 col-md-6 col-sm-12 ">
        <img src="images/team-1.png" class="team-images" alt="">
        <h4 class="my-2 mt-3 team-head">
          Angelika Sheglova
        </h4>
        <h6>Founder</h6>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-12 ">  
        <img src="images/team-2.png" class="team-images" alt="">
        <h4 class="my-2 mt-3 team-head">
          Angelika Sheglova
        </h4>
        <h6>Founder</h6>
      ...
      <div class="col-lg-3 col-md-6 col-sm-12 "> 
        <img src="images/team-3.png" class="team-images" alt="">
        <h4 class="my-2 mt-3 team-head">
          Angelika Sheglova
        </h4>
        <h6>Founder</h6>
      ...
      <div class="col-lg-3 col-md-6 col-sm-12 "> 
        <img src="images/team-4.png" class="team-images" alt="">
        <h4 class="my-2 mt-3 team-head">
          Angelika Sheglova
        </h4>
        <h6>Founder</h6>
